        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('update.tiem-chung', $data->id) }}" autocomplete="off">
                            @csrf
                                    ...
                                    <div class="col-12 d-flex flex-row px-0">
                                        <div class="col-8 pl-0">
                                            <div class="form-group{{ $errors->has('dateOfInjectionRegister') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="dateOfInjectionRegister" value="{{ date_format(new DateTime($data->date_of_injection), 'Y-m-d') }}" data-date-format="yyyy-mm-dd" class="form-control form-control-alternative{{ $errors->has('dateOfInjectionRegister') ? ' is-invalid' : '' }} datepicker" placeholder="{{ __('Chọn ngày mong muốn để tiêm') }}" required>
