@extends('layouts.app', ['title' => __('Khai Báo Theo Dõi Sức Khỏe')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('Khai Báo Theo Dõi Sức Khỏe') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('health-track.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="edit-information">
                                        ...
                                        <div class="col-4 pl-0">
                                            <div class="form-group{{ $errors->has('session_of_day') ? ' has-danger' : '' }}">
                                                ...
                                                <select class="form-control" name="session_of_day" required>
                                                    <option value="">Chọn buổi khai báo</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="daily_temperature">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-breathing_rate">{{ __('Nhịp thở') }}</label>
                                        <input class="form-control" type="text" name="breathing_rate">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="maximum_blood_pressure">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-minimum_blood_pressure">{{ __('Huyết áp tối thiểu (mmhg)') }}</label>
                                        <input type="text" class="form-control" name="minimum_blood_pressure">
                                    </div>
                                    <div class="form-group">
                                        <div class="d-flex flex-row">
                                            <h6 class="heading-small mb-4 mr-3">{{ __('Triệu Chứng Khác') }}</h6>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="no-symptom" name="no_symptoms" class="custom-control-input" value="0" onclick="symptomCheck ()" checked>
                                                <label class="custom-control-label" for="no-symptom">Không Triệu Chứng</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="has-symptom" name="no_symptoms" class="custom-control-input" value="1" onclick="symptomCheck ()">
                                                <label class="custom-control-label" for="has-symptom">Có Triệu Chứng Khác</label>
                                            </div>
                                        </div>
                                        <div class="form-group" style="display:none" id="symptoms">
                                            <div>
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td style="width: 10%">
                                                            <input type="radio" name="tired" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="tired" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Ho</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="cough" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="cough" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Ho ra đờm</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="productive_cough" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="productive_cough" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Ớn lạnh/gai rét</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="chills" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="chills" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Viêm kết mạc (mắt đỏ)</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="conjuntivitis" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="conjuntivitis" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Mất vị giác hoặc khứu giác</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="loss_of_taste_or_smell" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="loss_of_taste_or_smell" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Tiêu chảy (phân lỏng / đi ngoài)</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="diarrhea" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="diarrhea" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Ho ra máu</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="hemoptisi" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="hemoptisi" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Thở dốc hoặc khó thở</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="difficulty_breathing" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="difficulty_breathing" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Đau tức ngực kéo dài</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="chest_tightness" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="chest_tightness" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <th scope="row">Lơ mơ, không tỉnh táo</th>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="not_awake" value="1" class="ml-3">
                                                        </td>
                                                        <td style="width: 10%">
                                                            <input type="radio" name="not_awake" value="0" class="ml-3" checked>
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="note" placeholder="Các triệu chứng khác...">
                                    </div>
                                    @if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('ward') || auth()->user()->hasRole('district') || auth()->user()->hasRole('province'))
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="doctor_note" placeholder="Các triệu chứng khác...">
                                        </div>
                                    @endif
                                    <div>
